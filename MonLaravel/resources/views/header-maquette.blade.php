          ...
          <li id="navbar-menu-onglet-exercices" class="dropdown">
            ...
            <div class="dropdown-menu">
              <div id="navbar-menu-onglet-dropdown">
                ...
                <div class="col-1-1"><a class="dropdown-item" href="exercice">Exercice 1</a></div>
                <div class="col-1-2"><a class="dropdown-item" href="exercice">Exercice 2</a></div>
                <div class="col-1-2"><a class="dropdown-item" href="exercice">Exercice 3</a></div>
              </div>
              <div id="navbar-menu-onglet-dropdown">
                <div class="row"><h3 class="dropdown-header">Textes à trous</h3></div>
                <div class="col-2-1"><a class="dropdown-item" href="exercice">Exercice 1</a></div>
                <div class="col-2-2"><a class="dropdown-item" href="exercice">Exercice 2</a></div>
                <div class="col-2-3"><a class="dropdown-item" href="exercice">Exercice 3</a></div>
              </div>
              <div id="navbar-menu-onglet-dropdown">
                <div class="row"><h3 class="dropdown-header">Requêtes complètes</h3></div>
                <div class="col-3-1"><a class="dropdown-item" href="exercice">Exercice 1</a></div>
                <div class="col-3-2"><a class="dropdown-item" href="exercice">Exercice 2</a></div>
                <div class="col-3-3"><a class="dropdown-item" href="exercice">Exercice 3</a></div>
              </div>
              <h4><a id="voir-tout" class="dropdown-item" href="exercices">Voir tout<span class="glyphicon glyphicon-chevron-right"></a></h4>
            </div>
          </li>

          <li><a id="navbar-menu-onglet-notes" href="notes">NOTES</a></li>
        </ul>
