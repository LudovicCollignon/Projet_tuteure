        ...
        <ul id="navbar-menu-onglet" class="nav navbar-nav">
          ...
          <li id="navbar-menu-onglet-exercices" class="dropdown">
            ...
            <div class="dropdown-menu">
              ...
              <?php
                $exos = App\Exercice::all();
                foreach($exos as  $key => $e){
                  echo "<div class=\"col-1-1\"><a class=\"dropdown-item\" href=\""
                      .route('modele-exercice', [$e->id])
                      ."\"> Exercice "
                      .$e->id
                      ."</a></div>";
                }
               ?>
               <div class="row"><h3 class="dropdown-header">Requete complète</h3></div>
               <div class="col-1-1"><a class="dropdown-item" href="exercice-requete">Requête</a></div>
